...
// +---------------------------------------------------------------------------+
// AgaviConfig::set('core.agavi_dir', 'C:\PHP\pear\agavi');
...
AgaviConfig::set('core.project_dir', dirname(__DIR__));
AgaviConfig::set('core.vendor_dir', AgaviConfig::get('core.project_dir') . '/libs');
?>